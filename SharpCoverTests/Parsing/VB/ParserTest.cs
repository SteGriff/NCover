...
namespace SharpCover.Parsing.VB
{
	...
	public class ParserTest
	{
		...
		public void TestParseFile()
		{
			...
			ResourceManager.WriteResourceToStream(fs ,"SharpCover.Resources.CodeFile.vb", ResourceType.Text, this.GetType().Assembly);
			fs.Close();
		...
		{
			string retval;
			Stream stream = ResourceManager.GetResource("SharpCover.Resources.CodeFile.vb", this.GetType().Assembly);
